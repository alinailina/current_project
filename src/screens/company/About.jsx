  ...
  return (
    <div className={styles.about}>
      ...
      <p>
        ...
        это полноценная замена первичному хлопковому волокну. Почему необходима
        альтернатива первичному хлопковому волокну можно прочитать подробнее{" "}
        <Link to="blog">в нашем блоге</Link>.
      </p>
      <p>
