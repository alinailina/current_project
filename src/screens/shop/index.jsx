...
const Shop = () => {
  ...
  return (
    <div className={styles.container}>
      ...
      <section>
        <p>Наш магазин готовится к запуску в он-лайн режиме.</p>
        <p>
          Тем временем вы можете заказать у нас предметы униформы,
          представленные в галерее ниже. Все они изготовлены из списанного
          постельного белья из отелей. Текстиль был обработан по методу{" "}
          <a
