      ...
      <div className={styles.text2}>
        <div>
          ...
          <ul>
            <li>
              <div>
                <img src={require("../../assets/branch.svg")} alt="reduce" />
              </div>
              <span>reduce</span>
            ...
            <li>
              <div>
                <img src={require("../../assets/branch.svg")} alt="reuse" />
              </div>
              <span>reuse</span>
            ...
            <li>
              <div>
                <img src={require("../../assets/branch.svg")} alt="recycle" />
              </div>
              <span>recycle</span>
            ...
            <li>
              <div>
                <img src={require("../../assets/branch.svg")} alt="recover" />
              </div>
              <span>recover</span>
              <p>
